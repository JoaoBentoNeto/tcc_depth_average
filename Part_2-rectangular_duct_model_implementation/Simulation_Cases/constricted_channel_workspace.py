...
if __name__ == "__main__":
    ...
    simulation_name = "constricted_channel"
    ...
    depths = [55, 110, 220, 230, 452]

    depth_map_real = geometries.create_constricted_channel(characteristic_length=20, resolution=resolution)
