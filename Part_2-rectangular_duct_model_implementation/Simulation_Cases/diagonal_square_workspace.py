...
if __name__ == "__main__":
    ...
    simulation_name = "diagonal_square"
    ...
    depths = [32, round(50 * np.sqrt(2)), round(100 * np.sqrt(2)), round(200 * np.sqrt(2))]

    depth_map_real = geometries.create_diagonal_square(domain_size=100)
