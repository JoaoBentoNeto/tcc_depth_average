...
if __name__ == "__main__":
    ...
    simulation_geometry = geometries.create_u_channel(
        length_nodes=300, width_nodes=300, smoothing_sigma=4.0, percentage_radius=0.1
    )
    ...
    for depth in depths:
        ...
        depth_map = simulation_geometry * depth * resolution
